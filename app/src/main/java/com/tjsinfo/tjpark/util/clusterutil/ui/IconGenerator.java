...
public class IconGenerator {
    ...
    public void setBackground(Drawable background) {
        LayoutInflater inflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View view = inflater.inflate(R.layout.activity_cluters, null);
        ...
        mContainer.setBackgroundDrawable(new BitmapDrawable(bitmap.getBitmap()));

        if (background != null) {
            Rect rect = new Rect();
            background.getPadding(rect);
            mContainer.setPadding(15, 8, 10, 62);
        } else {
