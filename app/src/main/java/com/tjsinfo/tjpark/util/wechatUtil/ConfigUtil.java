package com.tjsinfo.tjpark.util.wechatUtil;

public class ConfigUtil {
	/**
	 * 服务号相关信息
	 */
	 public final static String APPID = "wxbda31b250a331d1d";//服务号的应用号
	 public final static String APP_SECRECT = "";//服务号的应用密码
	 public final static String TOKEN = "weixinCourse";//服务号的配置token
	 public final static String MCH_ID = "1503922241";//商户号
	 public final static String API_KEY = "iU0Ye28etTfhbAs7KjbbfVPPe1aW7k42";//API密钥
