...
/**
 * Created by panning on 2018/8/2.
 */
...
public class SelectPhotoActivity extends Activity implements OnClickListener {
    ...
    public static   String coustmerId= "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plateId = bundle.getString("plateId");
        coustmerId=bundle.getString("coustmerId");
    }
        ...
        switch (v.getId()) {
            case R.id.btn_take_photo:
                try{
                    ...
                    Toast.makeText(SelectPhotoActivity.this, "当前设备不支持拍照。", Toast.LENGTH_SHORT).show();
                }
                break;
...
//如果图片存在
            if(file.exists()){
                ...
                final String s =getImgBase64(bm);
                //上传到服务器
                new Thread(new Runnable() {
                    @Override
                    public void run() {

                        String strUrl = "/tjpark/app/UploadWebService/imgVerification?" +
                                "imgStr=" +s+
                                "&plateId="+plateId;
                        try{

                           NetConnection.post(s,plateId);
                        }
                        catch (Exception e){
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            intent.setClass(SelectPhotoActivity.this, TabBarActivity.class);
